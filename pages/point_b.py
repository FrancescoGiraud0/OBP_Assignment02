...
max_n = st.number_input("Max Number of Components (n)", value=k, min_value=k)
max_r = st.number_input("Max Repairmen", value=k, min_value=1)

if st.button("Find Optimal Configuration"):
    sys = System(max_n,k,max_r,failure_rate,repair_rate,cold_standby)
